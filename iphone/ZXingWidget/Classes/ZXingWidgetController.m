...
- (id)initWithDelegate:(id<ZXingDelegate>)scanDelegate showCancel:(BOOL)shouldShowCancel OneDMode:(BOOL)shouldUseoOneDMode showLicense:(BOOL)shouldShowLicense {
    return [self initWithDelegate:scanDelegate showCancel:shouldShowCancel OneDMode:shouldUseoOneDMode showLicense:shouldShowCancel useFrontCamera:NO];
}
- (id)initWithDelegate:(id<ZXingDelegate>)scanDelegate showCancel:(BOOL)shouldShowCancel OneDMode:(BOOL)shouldUseoOneDMode showLicense:(BOOL)shouldShowLicense useFrontCamera:(BOOL)shouldUseFrontCamera {
  self = [super init];
  if (self) {
    ...
    [self setUseFrontCamera:shouldUseFrontCamera];
  }
...
- (BOOL)shouldAutorotateToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation {
    return (toInterfaceOrientation == UIInterfaceOrientationPortrait || toInterfaceOrientation == UIInterfaceOrientationLandscapeRight);
}
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if (self.captureSession == nil) {
        NSLog(@"- (void)viewWillAppear:(BOOL)animated : self.captureSession == nil");
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    #if HAS_AVFF
    if (self.captureSession == nil) {
        NSLog(@"- (void)viewDidAppear:(BOOL)animated : self.captureSession == nil");
...
- (void)viewDidDisappear:(BOOL)animated {
  NSLog(@"- (void)viewDidDisappear:(BOOL)animated");
