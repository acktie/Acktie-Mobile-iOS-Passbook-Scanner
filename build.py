...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.acktie.mobile.ios.passbook.scanner.js')
	...
	f = os.path.join(cwd,'Classes','ComAcktieMobileIosPassbookScannerModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.acktie.mobile.ios.passbook.scanner.js']
